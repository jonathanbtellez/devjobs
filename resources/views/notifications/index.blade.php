                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="divide-y divide-gray-200">
                        @forelse ($notifications as $notification)
                            <div class="p-5 dark:border-gray-700 md:flex md:items-center md:justify-between">
                                <div>
                                    <p>Tienes un nuevo candidato en: <span
                                            class="font-bold">{{ $notification->data['name_vacante'] }}</span></p>
                                    <p><span
                                            class="font-bold text-sm">{{ $notification->created_at->diffForHumans() }}</span>
                                    </p>
                                </div>
                                <div class="mt-5 md:mt-0">
                                    <a href="{{ route('applicants.index', $notification->data['vacante_id']) }}"
